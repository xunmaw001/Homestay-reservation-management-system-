...
public class TechanEntity<T> implements Serializable {
    ...
    public String toString() {
        return "Techan{" +
            ...
            ", techanUuidNumber=" + techanUuidNumber +
            ", jingdianName=" + jingdianName +
            ", jingdianAddress=" + jingdianAddress +
            ", techanPhoto=" + techanPhoto +
            ", techanTypes=" + techanTypes +
            ", techanKucunNumber=" + techanKucunNumber +
            ", techanPrice=" + techanPrice +
            ", techanOldMoney=" + techanOldMoney +
            ", techanNewMoney=" + techanNewMoney +
            ", techanClicknum=" + techanClicknum +
            ", techanContent=" + techanContent +
            ", shangxiaTypes=" + shangxiaTypes +
            ", techanDelete=" + techanDelete +

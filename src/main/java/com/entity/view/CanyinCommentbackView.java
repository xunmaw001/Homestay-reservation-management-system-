...
public class CanyinCommentbackView extends CanyinCommentbackEntity implements Serializable {
	...
	public CanyinCommentbackView() {

	}

	public CanyinCommentbackView(CanyinCommentbackEntity canyinCommentbackEntity) {
		try {
			BeanUtils.copyProperties(this, canyinCommentbackEntity);

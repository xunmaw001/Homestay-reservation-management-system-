...
public class CanyinCollectionView extends CanyinCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 类型的值
		*/
		private String canyinCollectionValue;
	...
	public CanyinCollectionView() {

	}

	public CanyinCollectionView(CanyinCollectionEntity canyinCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, canyinCollectionEntity);
			...
			* 获取： 类型的值
			*/
			public String getCanyinCollectionValue() {
				return canyinCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setCanyinCollectionValue(String canyinCollectionValue) {
				this.canyinCollectionValue = canyinCollectionValue;
			}

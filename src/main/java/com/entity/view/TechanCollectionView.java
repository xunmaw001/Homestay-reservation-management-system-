...
public class TechanCollectionView extends TechanCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		...
		* 类型的值
		*/
		private String techanCollectionValue;
	...
	public TechanCollectionView(TechanCollectionEntity techanCollectionEntity) {
		try {
			...
			* 获取： 类型的值
			*/
			public String getTechanCollectionValue() {
				return techanCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setTechanCollectionValue(String techanCollectionValue) {
				this.techanCollectionValue = techanCollectionValue;
			}

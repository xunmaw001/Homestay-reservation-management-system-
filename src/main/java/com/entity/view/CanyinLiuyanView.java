...
public class CanyinLiuyanView extends CanyinLiuyanEntity implements Serializable {
	...
	public CanyinLiuyanView() {

	}

	public CanyinLiuyanView(CanyinLiuyanEntity canyinLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, canyinLiuyanEntity);

...
public class TechanLiuyanView extends TechanLiuyanEntity implements Serializable {
	...
	public TechanLiuyanView() {

	}

	public TechanLiuyanView(TechanLiuyanEntity techanLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, techanLiuyanEntity);

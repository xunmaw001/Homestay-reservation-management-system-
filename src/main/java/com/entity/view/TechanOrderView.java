...
public class TechanOrderView extends TechanOrderEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 订单类型的值
		*/
		private String techanOrderValue;
		/**
		* 支付类型的值
		*/
		private String techanOrderPaymentValue;
	...
	public TechanOrderView() {

	}

	public TechanOrderView(TechanOrderEntity techanOrderEntity) {
		try {
			BeanUtils.copyProperties(this, techanOrderEntity);
			...
			* 获取： 订单类型的值
			*/
			public String getTechanOrderValue() {
				return techanOrderValue;
			}
			/**
			* 设置： 订单类型的值
			*/
			public void setTechanOrderValue(String techanOrderValue) {
				this.techanOrderValue = techanOrderValue;
			}
			/**
			* 获取： 支付类型的值
			*/
			public String getTechanOrderPaymentValue() {
				return techanOrderPaymentValue;
			}
			/**
			* 设置： 支付类型的值
			*/
			public void setTechanOrderPaymentValue(String techanOrderPaymentValue) {
				this.techanOrderPaymentValue = techanOrderPaymentValue;
			}

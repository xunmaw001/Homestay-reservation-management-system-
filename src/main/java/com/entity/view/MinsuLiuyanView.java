...
public class MinsuLiuyanView extends MinsuLiuyanEntity implements Serializable {
	...
	public MinsuLiuyanView() {

	}

	public MinsuLiuyanView(MinsuLiuyanEntity minsuLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, minsuLiuyanEntity);
